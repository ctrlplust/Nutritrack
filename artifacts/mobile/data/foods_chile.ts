import { Product } from "../context/NutriContext";
...
export const FOOD_CATEGORIES: FoodCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "emb-04", barcode: "7802800110004", name: "Jamón de Pollo (laminado)", brand: "San Jorge", caloriesPer100g: 120, proteinPer100g: 16, carbsPer100g: 3, fatPer100g: 5 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fish-05", barcode: "7802800120004", name: "Albahacra (Cabrilla)", brand: "Pesca Chile", caloriesPer100g: 96, proteinPer100g: 20, carbsPer100g: 0, fatPer100g: 1.2 },
      ...
      { id: "fish-09", barcode: "7802800120008", name: "Choritos (Mejillones)", brand: "Pesca Chile", caloriesPer100g: 86, proteinPer100g: 12, carbsPer100g: 4, fatPer100g: 2 },
      ...
      { id: "fish-12", barcode: "7802800120011", name: "Camaron", brand: "Pesca Chile", caloriesPer100g: 84, proteinPer100g: 18, carbsPer100g: 0, fatPer100g: 0.9 },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "grain-10", barcode: "7802800140007", name: "Maíz Molido (Harina)", brand: "Carozzi", caloriesPer100g: 365, proteinPer100g: 8, carbsPer100g: 76, fatPer100g: 3.5 },
      ...
      { id: "grain-12", barcode: "7802800140009", name: "Cereal Granola Avena", brand: "Quaker", caloriesPer100g: 430, proteinPer100g: 10, carbsPer100g: 65, fatPer100g: 15 },
    ],
  },
  {
    name: "Legumbres",
    items: [
      { id: "leg-01", barcode: "7802800150001", name: "Porotos (Frijoles)", brand: "Granos del Sol", caloriesPer100g: 347, proteinPer100g: 22, carbsPer100g: 61, fatPer100g: 1.5 },
      ...
      { id: "leg-06", barcode: "7802800150006", name: "Soja (Poroto)", brand: "Granos del Sol", caloriesPer100g: 416, proteinPer100g: 36, carbsPer100g: 30, fatPer100g: 20 },
    ],
  },
  {
    name: "Verduras",
    items: [
      { id: "veg-01", barcode: "7802800160001", name: "Palta (Aguacate)", brand: "Fresh", caloriesPer100g: 160, proteinPer100g: 2, carbsPer100g: 9, fatPer100g: 15 },
      ...
      { id: "veg-07", barcode: "7802800160007", name: "Zapallo (Calabaza)", brand: "Fresh", caloriesPer100g: 26, proteinPer100g: 1, carbsPer100g: 6, fatPer100g: 0.1 },
      ...
      { id: "veg-13", barcode: "7802800160013", name: "Choclo (Maíz)", brand: "Fresh", caloriesPer100g: 96, proteinPer100g: 3.4, carbsPer100g: 21, fatPer100g: 1.5 },
      ...
      { id: "veg-19", barcode: "7802800160019", name: "Betarraga (Remolacha)", brand: "Fresh", caloriesPer100g: 43, proteinPer100g: 1.6, carbsPer100g: 9.6, fatPer100g: 0.2 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fruit-13", barcode: "7802800170013", name: "Palta", brand: "Fresh", caloriesPer100g: 160, proteinPer100g: 2, carbsPer100g: 9, fatPer100g: 15 },
      ...
      { id: "fruit-17", barcode: "7802800170017", name: "Tuna (Higo chumbo)", brand: "Fresh", caloriesPer100g: 41, proteinPer100g: 0.7, carbsPer100g: 10, fatPer100g: 0.1 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "nut-03", barcode: "7802800180002", name: "Maní (Cacahuate)", brand: "Planters", caloriesPer100g: 567, proteinPer100g: 26, carbsPer100g: 16, fatPer100g: 49 },
  ...
  {
    name: "Condimentos, Salsas y Conservas",
    items: [
      ...
      { id: "cond-07", barcode: "7802800220007", name: "Manjar (Dulce de Leche)", brand: "Colún", caloriesPer100g: 310, proteinPer100g: 7.5, carbsPer100g: 58, fatPer100g: 6 },
      ...
      { id: "cond-10", barcode: "7802800220010", name: "Conservas Tomate Pelado", brand: "Malloa", caloriesPer100g: 20, proteinPer100g: 0.9, carbsPer100g: 4.3, fatPer100g: 0.2 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "dish-08", barcode: "7802800230008", name: "Completo (Hot dog chileno)", brand: "Caserito", caloriesPer100g: 220, proteinPer100g: 8, carbsPer100g: 22, fatPer100g: 11 },
...
export const ALL_CHILEAN_FOODS: Product[] = FOOD_CATEGORIES.flatMap(
  (cat) => cat.items,
);

export const CHILEAN_FOODS_BY_BARCODE: Map<string, Product> = new Map(
  ALL_CHILEAN_FOODS.filter((p) => p.barcode).map((p) => [p.barcode!, p]),
);
